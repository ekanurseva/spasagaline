        ...
        <div class="content">
            ...
            <div class="contents px-4 py-3">
                ...
                <div class="row px-3">
                    <div class="card me-5">
                        <div class="card-body">
                            <a href="input-user.php" class="fw-medium">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="input-admin.php" class="fw-medium">
                                <i class="bi bi-plus-square"></i>
                    ...
                    <table class="table table-hover text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>User</td>
                                <td>
                                    <a href="edit-pengguna.php"><i class="bi bi-pencil-fill"></i></a> | <a href="#"><i
                            ...
                            <tr>
                                ...
                                <td>Admin</td>
                                <td>
                                    <a href="#"><i class="bi bi-pencil-fill"></i></a> | <a href="#"><i
                                            class="bi bi-trash-fill"></i></a>
                                </td>
                            </tr>
                        </tbody>
