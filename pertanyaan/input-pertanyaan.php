                ...
                <div class="tabel text-white px-5 py-4">
                    <div class="row pb-1">
                        <div class="col-6">
                            ...
                            <input type="text" value="I1" class="form-control" readonly>
                        </div>
                        <div class="col-6">
                            <label for="kriteria" class="col-form-label">Kode Pertanyaan</label>
                            <input type="text" class="form-control" value="G1" readonly>
                        </div>
                    </div>
                    <div class="row pb-1">
                        <div class="col-6">
